...
/**
 * This is used to store data of order
 * Instances of this enum have to be same as "MenuInventory" enum and "MenuTempStorage" enum
 * */
public enum MenuOrder {
    ...
    MenuOrder(int smallSize, int regularSize, int largeSize){
